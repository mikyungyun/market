    ...
    <div className="mt-16 px-5">
      ...
      <div className="mt-8">
        <div className="flex flex-col items-center">
          ...
          <div className="grid grid-cols-2 gap-16 mt-8 pb-4 w-full">
            <button
              className={cls(
                'font-medium pb-4',
                method === 'email'
        ...
        <div className="mt-8">
          ...
          <div className="grid grid-cols-2 gap-3 mt-6">
            <button className="flex justify-center items-center py-2 px-3 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-500 hover:bg-gary-500">
              <svg
                className="w-5 h-5"
                aria-hidden="true"
                fill="currentColor"
